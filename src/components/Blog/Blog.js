        ...
        <div className='mb-10 mt-5'>
            ...
            <div className='flex flex-col gap-5'>
                <div className='bg-white shadow-lg p-3 rounded-md'>
                    <h2 className='text-xl font-semibold mb-4'>Question-01: How Does React Work?</h2>
                    <p className='mb-3'>React is a very popular JavaScript library.With over 5.5 million weekly downloads, React is enjoying great popularity. ReactJS divides the UI into isolated reusable pieces of code known as components. React components work similarly to JavaScript functions as they accept arbitrary inputs called properties or props. It's possible to have as many components as necessary without cluttering your code. At its very core, React basically maintains a tree for you. This tree is able to do efficient diff computations on the nodes. React allows you to effectively reconstruct your DOM in JavaScript and push only those changes to the DOM which have actually occurred.
                    </p>
                </div>
                <div className='bg-white shadow-lg p-3 rounded-md'>
                    <h2 className='text-xl font-semibold mb-4'>Question-02: Difference between Props and State?</h2>
                ...
                <div className='bg-white shadow-lg p-3 rounded-md'>
                    <h2 className='text-xl font-semibold mb-4'>Question-03: Where else can we use useEffect other than data load?</h2>
